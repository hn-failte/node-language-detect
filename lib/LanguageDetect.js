...
var LanguageDetect = module.exports = function ({ languageType, supportLangs } = { languageType: '', supportLangs: null }) {
  ...
  if (Array.isArray(supportLangs)) {
    for (const lang of Object.keys(this.langDb)) {
      if (!supportLangs.includes(lang)) this.langDb[lang] = {}
    }
  }
};
